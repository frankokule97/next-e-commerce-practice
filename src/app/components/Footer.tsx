                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        <div className="mb-8 md:mb-0 md:max-w-xl">
                            ...
                            <p className="text-white/80">Get the latest products, promotions, and tech news deliver to our inbox.</p>
                        </div>
                        <div className="w-full md:w-auto">
                            <form className="flex flex-col sm:flex-row gap-2">
                                <input
                                    ...
                                    className="px-5 py-3 rounded-lg bg-white/10 border border-white/20 text-white
                                    focus:outline-none focus:ring-2 focus:ring-[#edae49] min-w-[240px] transition-all" required />
                                <button
                                    type="submit"
                                    className="bg-[#edae49] hover:bg-[#edae49]/90 text-white px-6 py-3 rounded-lg transform
                                     hover:scale-105 font-medium flex items-center justify-center transition-all">Subscribe
                ...
                <div className="grid grid-cols md:grid-cols-12 gap-8">
                    <div className="col-span-2 md:col-span-4">
                        <Link href="/" className="flex items-center mb-6">
                            <div
                                className="bg-[#edae49] text-[#003d5b] w-10 h-10 rounded-full flex items-center justify-center font-bold text-xl mr-2">
                                SB
                            </div>
                            <span className="text-xl font-bold text-[#003d5b">Store
                        ...
                        <div className="flex space-x-4">
                            {["facebook", "instagram", "linkedin", "youtube"].map((platform) => (
                                <a
                                    ...
                                    bg-gray-100 hover:bg-[#003d5b] transform hover:scale-100">
                                    <i
                                        className={`bx bxl-${platform} text-gray-500 
                                        group-hover:white text-xl transition-colors`}>
                                    </i>
                                </a>
                            ))}
                        </div>
                        ...
                        <ul className="space-y-2.5">
                            {categories.slice(0, 5).map((category) => (
                                <li key={category.slug}>
                                    <Link
                                        href="/products"
                                        className="text-gray-600 hover:text-[#00798c]
                                        hover:translate-x-1 inline-flex items-center transition-all">
                            ...
                            <li>
                                <Link
                                    href="/products"
                                    className="text-[#00798c] hover:text-[#003d5b] font-medium
                                    hover:translate-x-1 inline-flex items-center transition-all group">View All
                        ...
                        <ul className="space-y-2.5">
                            {["All Products", "New Arrivals", "Best Sellers", "Deals", "Gift Cards"].map((item) => (
                                <li key={item}>
                                    <a
                                        href="#"
                                        className="text-gray-600 hover:text-[#00798c] hover:translate-x-1 inline-flex transition-all">
                                        {item}
                                    </a>
                                </li>
                            ))}
